/**
 * GET /api/anakjuara/anak-juara/{id}/pdf-surat
 * Same "Profil Surat" PDF as the Calon Anak Juara menu
 * (app/api/anakjuara/calon-anak-juara/[id]/pdf-surat/route.ts), reused here
 * for an already-promoted 'aj' child. id = id_anak.
 */
  ...
  try {
    ...
    return new Response(new Uint8Array(pdf), {
      ...
      headers: {
        ...
        'Content-Disposition': `inline; filename="surat-aj-${id}.pdf"`,
    ...
    console.error('[anak-juara pdf-surat]', err);
